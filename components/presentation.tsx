...
export const Presentation = () => {
  return (
    /* L'ID permet au menu de trouver cette section, et scroll-mt gère l'espace sous la Navbar */
    <section id="presentation" className="py-16 px-6 max-w-5xl mx-auto text-white scroll-mt-32">
